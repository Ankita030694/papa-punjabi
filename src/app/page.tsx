...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#F5EFE6] text-[#222222] font-sans pb-12 overflow-x-hidden">
      ...
      <div className="fixed bottom-0 left-0 w-full bg-[#5C3317]/95 backdrop-blur-sm text-[#F5EFE6] py-3 md:py-5 px-6 md:px-12 items-center justify-center border-t border-[#4A2912] z-[100] shadow-[0_-4px_20px_rgba(0,0,0,0.1)]">
        <div className="max-w-[1340px] mx-auto grid grid-cols-3 items-center">
          
          {/* 1st Column: WhatsApp Message Icon */}
          <div className="flex justify-center">
            <a 
            ...
            >
              <svg 
                ...
                viewBox="0 0 24 24" 
                fill="currentColor" 
                className="w-8 h-8 md:w-10 md:h-10 text-[#25D366]"
              >
          ...
          {/* 2nd Column: WhatsApp Catalogue */}
          <div className="flex justify-center">
            <a 
              href="https://wa.me/c/917428199631" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-[12px] sm:text-sm md:text-[20px] font-bold hover:text-white transition-colors underline underline-offset-4 decoration-[#F5EFE6]/40 hover:decoration-white whitespace-nowrap"
            >
              WhatsApp Catalogue
            </a>
          </div>

          {/* 3rd Column: Phone Number */}
          <div className="flex justify-center">
            <a 
              href="tel:+917428199631" 
              className="text-[12px] sm:text-sm md:text-[22px] font-bold tracking-widest hover:text-white transition-colors whitespace-nowrap"
            >
              +91 74281 99631
            </a>
          </div>
