...
export const metadata: Metadata = {
  ...
  description: "Browse our selection of handcrafted Punjabi dishes. From Fauji Mutton and Chicken Black Pepper to Dal Makhni and Paneer specialties, find your favorite home-style meal.",
  openGraph: {
