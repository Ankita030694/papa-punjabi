...
export default function PunjabiHero() {
  ...
  const widthTransform = useTransform(scrollYProgress, [0, 1], ["65vw", "100vw"]);
  const heightTransform = useTransform(scrollYProgress, [0, 1], ["65vh", "100vh"]);
  const topTransform = useTransform(scrollYProgress, [0, 1], ["15vh", "0vh"]);
  ...
  return (
    <div ref={containerRef} className="relative h-[160vh] bg-[#f4eedb]">
      <div className="sticky top-0 h-[80vh] w-full overflow-hidden flex flex-col items-center justify-start">
